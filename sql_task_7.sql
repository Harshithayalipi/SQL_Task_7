CREATE DATABASE SqlTechCompany;
...
INSERT INTO Employees (emp_id, emp_name, department_id, salary, hire_date) VALUES
(101, 'Vijay', 1, 50000.00, '2020-03-15'),
(102, 'Arav', 2, 60000.00, '2019-07-01'),
(103, 'Mike', 2, 70000.00, '2018-11-21'),
(104, 'David', 3, 65000.00, '2021-05-30'),
(105, 'Ester', 1, 55000.00, '2022-01-10');
